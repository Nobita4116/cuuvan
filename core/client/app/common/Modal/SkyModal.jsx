...
class SkyModal extends Component {
    constructor(props) {
        super(props);
    }
    render() {
        let { title, backdrop, isShow, handleHide, headerStyle, size, hasButtonCancel, hasButtonAction, onClickAction, textAction } = this.props;
        size = size || 'large';
        isShow = isShow || false;
